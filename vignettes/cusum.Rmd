...
The false signal probabilty of a CUSUM chart can be simulated using _cusum_alpha_sim_ given a pre-defined control limit.
...
The false signal probabilty of a CUSUM chart can be simulated using _cusum_alpha_sim_.
